...
class Bidi
  ...
  def initialize
    ...
    @idxFile = File.open(dirname + "/UnicodeData.idx", "r");
    @dataFile = File.open(dirname + "/UnicodeData.txt", "r");
    @mirrorFile = File.open(dirname + "/BidiMirroring.dat", "r");
